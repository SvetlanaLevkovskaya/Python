...
#  то вывести в консоль (“Переменная item_1 меньше”, comp_item), иначе, вывести в консоль
...
#                     и usd_eur_rate. Результат вывести в консоль
...
#                     получится при target_currency_amount и usd_uah_rate.
