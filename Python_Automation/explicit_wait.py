...
flight_where_search = driver.find_element(By.XPATH, '//*[@id="location-field-leg1-origin-menu"]/div[2]/div[2]/ul/li[6]/button/div').click()
...
flight_to_search = driver.find_element(By.XPATH, '//*[@id="location-field-leg1-destination-menu"]/div[2]/div[2]/ul/li[6]/button').click()
...
time.sleep(2)
# data_1 = driver.find_element(By.XPATH, '//*[@id="wizard-flight-tab-roundtrip"]/div[2]/div[2]/div/div/div[1]/div/div[2]/div/div[2]/div[2]/div[1]/table/tbody/tr[4]/td[5]/button').click()
data_1_1 = driver.find_element(By.XPATH, '//*[@id="wizard-flight-tab-roundtrip"]/div[2]/div[2]/div/div/div[1]/div/div[2]/div/div[3]/button').click()
# print(data_1)
time.sleep(2)
...
time.sleep(2)
# data_1 = driver.find_element(By.XPATH, '//*[@id="wizard-flight-tab-roundtrip"]/div[2]/div[2]/div/div/div[1]/div/div[2]/div/div[2]/div[2]/div[1]/table/tbody/tr[4]/td[5]/button').click()
data_2_1 = driver.find_element(By.XPATH, '//*[@id="wizard-flight-tab-roundtrip"]/div[2]/div[2]/div/div/div[2]/div/div[2]/div/div[3]/button').click()
# print(data_1)
time.sleep(2)
