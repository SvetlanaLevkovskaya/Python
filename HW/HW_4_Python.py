...
# 	 - В теле if сделать ещё одни цикл for с переменной inner_item который будет
# 	 работать пока счётчик range досчитает от 0 до item.
